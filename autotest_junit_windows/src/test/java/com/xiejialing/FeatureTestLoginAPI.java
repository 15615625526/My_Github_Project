...
public class FeatureTestLoginAPI {
    @And("接口测试")
    public void testLoginAPI() throws IOException {
        ...
        assertEquals(1, status, "Login was not successful");
        ...
        assertTrue(decodedInfo.contains("登录成功"));
        assertTrue(formattedResponse.contains("登录成功"));
