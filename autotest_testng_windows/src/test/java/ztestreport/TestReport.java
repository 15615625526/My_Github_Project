...
public class TestReport implements IReporter {
    ...
    private String path = System.getProperty("user.dir") + File.separator + "src/test/java/ztestreport" + File.separator + reportdate + ".html";
    // 定义html样式模板所在路径
    private String templatePath = System.getProperty("user.dir") + File.separator + "src/test/java/ztestreport/template";
